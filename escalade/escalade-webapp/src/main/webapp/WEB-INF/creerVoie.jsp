...
<html>
    ...
    <c:import url="/inc/navBar.jsp"/>
	    <div class="bg_creervoie pt-3 pl-3">	
			<h3>Créer une nouvelle voie</h3>
			<div class="container pt-5 col-md-4" id="creervoie_block">
			...
			<form method="POST" action="<c:url value="/sites/creersite/creervoie/"/>"> 
				...
				<div class="form-group" >
					...
					<span class="erreur rounded">${vm.erreurs['nomVoie']}</span>
				</div>
				<div class="form-group">
					...
					<span class="erreur rounded">${vm.erreurs['hauteurVoie']}</span>
				</div>
				<div class="form-group">
				...
				<p class="h5 pt-3 text-danger"> ${ vm.result } </p> 
			</div>
		</div>	
    </body>
</html>
